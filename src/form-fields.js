...
export const CANONICAL_FIELDS = [
  ...
  { key: "workYears", label: "工作年限", type: "select", keywords: ["工作年限", "工作经验", "工作年数", "从业年限", "年限", "work years", "years of experience", "experience years", "experience"] },
  { key: "currentCompany", label: "现公司", type: "text", keywords: ["当前公司", "现公司", "目前公司", "就职公司", "现就职", "现工作单位", "工作单位", "当前雇主", "current company", "employer", "company"] },
